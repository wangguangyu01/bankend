$().ready(function() {
	validateRule();
	getSelectByType("JZJGLXDM","jzjglxdm",$("#jzjglxdmVal").val()); //建筑结构
	getSelectByType("JZWSYXZDM","jzwsyxzdm",$("#jzwsyxzdmVal").val()); //建筑物使用
	getSelectByType("JZWNHDJDM","jzwnhdjdm",$("#jzwnhdjdmVal").val()); //建筑物耐火等级
	initFileInput("input-id",zdbwtzList);
});
