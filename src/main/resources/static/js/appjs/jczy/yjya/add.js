$().ready(function() {
	...
	// 预案种类代码
	getSelectByType("YAZLDM","yazldm",null);
	// 应急预案类型类别
	getSelectAll("YJYALXLBDM","YJYALXLBDM-DIV","yjyalxlbdm","yjyalxlbdm-title");
	// 获取行政区划
...
function initFileInput(ctrlName) {
	...
	control.fileinput({
		...
		allowedFileExtensions: ['jpg', 'gif', 'png','doc','docx','xls','ppt'],//接收的文件后缀
