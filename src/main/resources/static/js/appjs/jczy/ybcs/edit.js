$().ready(function() {
    console.log("123");
    getSelectByType("YBCSLX","cslb",$("#cslbVal").val()); //场所类型
	validateRule();

	console.log("wjt");
    initFileInput("wjt",wjt);
    initFileInput("ylsn",ylsn);
    initFileInput("elsn",elsn);
    initFileInput("slsn",slsn);
});
