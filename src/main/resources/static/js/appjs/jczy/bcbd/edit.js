$().ready(function() {
    ...
    localStorage.setItem("remembermeDataList",JSON.stringify(bcbdZzdyList))
});
...
function getzzdyid(){
	$.each(bcbdZzdyList, function(i, row) {
        $('#addzzdy').append("<span style='line-height:30px;'id='zzdy"+i+"' name='zzdy"+i+"' class='label label-info'>"+row['zzdymc']+"</span>&nbsp;")
	});
}