$().ready(function() {
	validateRule();
    getSelectByType("XHSLBDM","xhslbdm",$("#xhslbdmVal").val());
    getSelectAll("XFSSZKFLYDM","XFSSZKFLYDM-DIV","xfsszkflydm","xfsszkflydm-title");
    getSelectByType("XHSFZXSLBDM","xhsfzxslbdm",$("#xhsfzxslbdmVal").val());
