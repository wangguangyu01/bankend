...
import com.smart119.common.service.GeneratorService;
import com.smart119.common.utils.GenUtils;
...
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"smart119.zip\"");
