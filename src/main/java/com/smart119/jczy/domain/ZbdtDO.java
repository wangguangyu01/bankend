...
public class ZbdtDO implements Serializable {
	...
	//值班人员_消防值班角色类别
	private String zbryXfzbjslb;
	//值班人员_消防岗位分类与代码
	private String zbryXfgwflydm;
	//值班人员_消防岗位分类与
	private String zbryXfgwfly;
	//值班人员_单位名称
	...
	public String getZbryXfzbjslb() {
		return zbryXfzbjslb;
	}

	public void setZbryXfzbjslb(String zbryXfzbjslb) {
		this.zbryXfzbjslb = zbryXfzbjslb;
	}

	public String getZbryXfgwfly() {
		return zbryXfgwfly;
	}

	public void setZbryXfgwfly(String zbryXfgwfly) {
		this.zbryXfgwfly = zbryXfgwfly;
	}
}
